...
import {addMoneyToBudget, createMessage, repairHouse, toFireStaff, toHireStaff} from "./03-02";
...
test('Greeting should be correct for city', () => {
   ...
   expect(message).toBe('Hello NewYork citizen. I want you be happy. All 1000000 men');
});